...
using MapUtilitiesSample.MapUtilitiesSample_XamlTypeInfo;
...
namespace MapUtilitiesSample.MapUtilitiesSample_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_1_MapUIElementCollection() { return new Bing.Maps.MapUIElementCollection(); }

        private object Activate_2_Location() { return new Bing.Maps.Location(); }

        private object Activate_3_MapTileLayerCollection() { return new Bing.Maps.MapTileLayerCollection(); }

        private object Activate_4_MapTileLayer() { return new Bing.Maps.MapTileLayer(); }

        private object Activate_5_MapShapeLayerCollection() { return new Bing.Maps.MapShapeLayerCollection(); }

        private object Activate_6_MapShapeLayer() { return new Bing.Maps.MapShapeLayer(); }

        private object Activate_7_MapShapeCollection() { return new Bing.Maps.MapShapeCollection(); }

        private object Activate_9_LocationRect() { return new Bing.Maps.LocationRect(); }

        private object Activate_14_MainPage() { return new MapUtilitiesSample.MainPage(); }

        private object Activate_15_RoundMapMarker() { return new MapUtilitiesSample.RoundMapMarker(); }

        private object Activate_16_SquareMapMarker() { return new MapUtilitiesSample.SquareMapMarker(); }

        private object Activate_17_Pushpin() { return new Bing.Maps.Pushpin(); }
        ...
        private void VectorAdd_3_MapTileLayerCollection(object instance, object item)
        {
        ...
        private void VectorAdd_5_MapShapeLayerCollection(object instance, object item)
        {
        ...
        private void VectorAdd_7_MapShapeCollection(object instance, object item)
        {
        ...
        private List<IXamlMetadataProvider> OtherProviders
        {
            get
            {
                if(_otherProviders == null)
                {
                    ...
                    provider = new FatAttitude.Utilities.Metro.Mapping.MapManager_Metro_XamlTypeInfo.XamlMetaDataProvider() as IXamlMetadataProvider;
        ...
        private object get_4_Map_SuppressNetworkRequests(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.SuppressNetworkRequests;
        }
        private void set_4_Map_SuppressNetworkRequests(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.SuppressNetworkRequests = (System.Boolean)Value;
        }
        private object get_5_Map_ShowScaleBar(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.ShowScaleBar;
        }
        private void set_5_Map_ShowScaleBar(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.ShowScaleBar = (System.Boolean)Value;
        }
        private object get_6_Map_TileLayers(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.TileLayers;
        }
        private object get_7_MapTileLayer_Visible(object instance)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            return that.Visible;
        }
        private void set_7_MapTileLayer_Visible(object instance, object Value)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            that.Visible = (System.Boolean)Value;
        }
        private object get_8_MapTileLayer_ZIndex(object instance)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            return that.ZIndex;
        }
        private void set_8_MapTileLayer_ZIndex(object instance, object Value)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            that.ZIndex = (System.Int32)Value;
        }
        private object get_9_MapTileLayer_TileSource(object instance)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            return that.TileSource;
        }
        private void set_9_MapTileLayer_TileSource(object instance, object Value)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            that.TileSource = (System.String)Value;
        }
        private object get_10_MapTileLayer_Opacity(object instance)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            return that.Opacity;
        }
        private void set_10_MapTileLayer_Opacity(object instance, object Value)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            that.Opacity = (System.Double)Value;
        }
        private object get_11_Map_ShapeLayers(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.ShapeLayers;
        }
        private object get_12_MapShapeLayer_Visible(object instance)
        {
            var that = (Bing.Maps.MapShapeLayer)instance;
            return that.Visible;
        }
        private void set_12_MapShapeLayer_Visible(object instance, object Value)
        {
            var that = (Bing.Maps.MapShapeLayer)instance;
            that.Visible = (System.Boolean)Value;
        }
        private object get_13_MapShapeLayer_ZIndex(object instance)
        {
            var that = (Bing.Maps.MapShapeLayer)instance;
            return that.ZIndex;
        }
        private void set_13_MapShapeLayer_ZIndex(object instance, object Value)
        {
            var that = (Bing.Maps.MapShapeLayer)instance;
            that.ZIndex = (System.Int32)Value;
        }
        private object get_14_MapShapeLayer_Shapes(object instance)
        {
            var that = (Bing.Maps.MapShapeLayer)instance;
            return that.Shapes;
        }
        private void set_14_MapShapeLayer_Shapes(object instance, object Value)
        {
            var that = (Bing.Maps.MapShapeLayer)instance;
            that.Shapes = (Bing.Maps.MapShapeCollection)Value;
        }
        private object get_15_MapShape_Visible(object instance)
        {
            var that = (Bing.Maps.MapShape)instance;
            return that.Visible;
        }
        private void set_15_MapShape_Visible(object instance, object Value)
        {
            var that = (Bing.Maps.MapShape)instance;
            that.Visible = (System.Boolean)Value;
        }
        ...
        private object get_18_Map_Culture(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.Culture;
        }
        private void set_18_Map_Culture(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.Culture = (System.String)Value;
        }
        private object get_19_Map_TargetBounds(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.TargetBounds;
        }
        private object get_20_Map_Bounds(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.Bounds;
        }
        private object get_21_Map_ShowTraffic(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.ShowTraffic;
        }
        private void set_21_Map_ShowTraffic(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.ShowTraffic = (System.Boolean)Value;
        }
        private object get_22_Map_PreloadArea(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.PreloadArea;
        }
        private void set_22_Map_PreloadArea(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.PreloadArea = (Bing.Maps.PreloadArea)Value;
        }
        private object get_23_Map_MapType(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.MapType;
        }
        private void set_23_Map_MapType(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.MapType = (Bing.Maps.MapType)Value;
        }
        private object get_24_Map_TargetHeading(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.TargetHeading;
        }
        private object get_25_Map_TargetZoomLevel(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.TargetZoomLevel;
        }
        private object get_26_Map_TargetCenter(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.TargetCenter;
        }
        private object get_27_Map_Heading(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.Heading;
        }
        private void set_27_Map_Heading(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.Heading = (System.Double)Value;
        }
        private object get_28_Map_MetersPerPixel(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.MetersPerPixel;
        }
        private object get_29_Location_Latitude(object instance)
        {
            var that = (Bing.Maps.Location)instance;
            return that.Latitude;
        }
        private void set_29_Location_Latitude(object instance, object Value)
        {
            var that = (Bing.Maps.Location)instance;
            that.Latitude = (System.Double)Value;
        }
        private object get_30_Location_Longitude(object instance)
        {
            var that = (Bing.Maps.Location)instance;
            return that.Longitude;
        }
        private void set_30_Location_Longitude(object instance, object Value)
        {
            var that = (Bing.Maps.Location)instance;
            that.Longitude = (System.Double)Value;
        }
        private object get_31_RoundMapMarker_MarkerText(object instance)
        {
            var that = (MapUtilitiesSample.RoundMapMarker)instance;
            return that.MarkerText;
        }
        private void set_31_RoundMapMarker_MarkerText(object instance, object Value)
        {
            var that = (MapUtilitiesSample.RoundMapMarker)instance;
            that.MarkerText = (System.String)Value;
        }
        private object get_32_RoundMapMarker_PositionAnchor(object instance)
        {
            var that = (MapUtilitiesSample.RoundMapMarker)instance;
            return that.PositionAnchor;
        }
        private object get_33_SquareMapMarker_MarkerText(object instance)
        {
            var that = (MapUtilitiesSample.SquareMapMarker)instance;
            return that.MarkerText;
        }
        private void set_33_SquareMapMarker_MarkerText(object instance, object Value)
        {
            var that = (MapUtilitiesSample.SquareMapMarker)instance;
            that.MarkerText = (System.String)Value;
        }
        private object get_34_SquareMapMarker_PositionAnchor(object instance)
        {
            var that = (MapUtilitiesSample.SquareMapMarker)instance;
            return that.PositionAnchor;
        }
        private object get_35_Pushpin_Text(object instance)
        {
            var that = (Bing.Maps.Pushpin)instance;
            return that.Text;
        }
        private void set_35_Pushpin_Text(object instance, object Value)
        {
            var that = (Bing.Maps.Pushpin)instance;
        ...
        private IXamlMember CreateXamlMember(string longMemberName)
        {
            ...
            case "Bing.Maps.Map.SuppressNetworkRequests":
                ...
                xamlMember.Getter = get_4_Map_SuppressNetworkRequests;
                xamlMember.Setter = set_4_Map_SuppressNetworkRequests;
                break;
            case "Bing.Maps.Map.ShowScaleBar":
                userType = (XamlUserType)GetXamlTypeByName("Bing.Maps.Map");
                xamlMember = new XamlMember(this, "ShowScaleBar", "Boolean");
                xamlMember.Getter = get_5_Map_ShowScaleBar;
                xamlMember.Setter = set_5_Map_ShowScaleBar;
                break;
            case "Bing.Maps.Map.TileLayers":
                userType = (XamlUserType)GetXamlTypeByName("Bing.Maps.Map");
                xamlMember = new XamlMember(this, "TileLayers", "Bing.Maps.MapTileLayerCollection");
                xamlMember.Getter = get_6_Map_TileLayers;
                xamlMember.SetIsReadOnly();
                break;
            case "Bing.Maps.MapTileLayer.Visible":
                ...
                xamlMember.Getter = get_7_MapTileLayer_Visible;
                xamlMember.Setter = set_7_MapTileLayer_Visible;
                break;
            case "Bing.Maps.MapTileLayer.ZIndex":
                userType = (XamlUserType)GetXamlTypeByName("Bing.Maps.MapTileLayer");
                xamlMember = new XamlMember(this, "ZIndex", "Int32");
                xamlMember.Getter = get_8_MapTileLayer_ZIndex;
                xamlMember.Setter = set_8_MapTileLayer_ZIndex;
                break;
            case "Bing.Maps.MapTileLayer.TileSource":
                userType = (XamlUserType)GetXamlTypeByName("Bing.Maps.MapTileLayer");
                xamlMember = new XamlMember(this, "TileSource", "String");
                xamlMember.Getter = get_9_MapTileLayer_TileSource;
                xamlMember.Setter = set_9_MapTileLayer_TileSource;
                break;
            case "Bing.Maps.MapTileLayer.Opacity":
                userType = (XamlUserType)GetXamlTypeByName("Bing.Maps.MapTileLayer");
                xamlMember = new XamlMember(this, "Opacity", "Double");
                xamlMember.Getter = get_10_MapTileLayer_Opacity;
                xamlMember.Setter = set_10_MapTileLayer_Opacity;
                break;
            case "Bing.Maps.Map.ShapeLayers":
                userType = (XamlUserType)GetXamlTypeByName("Bing.Maps.Map");
                xamlMember = new XamlMember(this, "ShapeLayers", "Bing.Maps.MapShapeLayerCollection");
                xamlMember.Getter = get_11_Map_ShapeLayers;
                xamlMember.SetIsReadOnly();
                break;
            case "Bing.Maps.MapShapeLayer.Visible":
                userType = (XamlUserType)GetXamlTypeByName("Bing.Maps.MapShapeLayer");
                xamlMember = new XamlMember(this, "Visible", "Boolean");
                xamlMember.Getter = get_12_MapShapeLayer_Visible;
                xamlMember.Setter = set_12_MapShapeLayer_Visible;
                break;
            case "Bing.Maps.MapShapeLayer.ZIndex":
                userType = (XamlUserType)GetXamlTypeByName("Bing.Maps.MapShapeLayer");
                xamlMember = new XamlMember(this, "ZIndex", "Int32");
                xamlMember.Getter = get_13_MapShapeLayer_ZIndex;
                xamlMember.Setter = set_13_MapShapeLayer_ZIndex;
                break;
            case "Bing.Maps.MapShapeLayer.Shapes":
                userType = (XamlUserType)GetXamlTypeByName("Bing.Maps.MapShapeLayer");
                xamlMember = new XamlMember(this, "Shapes", "Bing.Maps.MapShapeCollection");
                xamlMember.Getter = get_14_MapShapeLayer_Shapes;
                xamlMember.Setter = set_14_MapShapeLayer_Shapes;
                break;
            case "Bing.Maps.MapShape.Visible":
                userType = (XamlUserType)GetXamlTypeByName("Bing.Maps.MapShape");
                xamlMember = new XamlMember(this, "Visible", "Boolean");
                xamlMember.Getter = get_15_MapShape_Visible;
                xamlMember.Setter = set_15_MapShape_Visible;
                break;
            ...
            case "Bing.Maps.Location.Latitude":
                ...
                xamlMember.Getter = get_29_Location_Latitude;
                xamlMember.Setter = set_29_Location_Latitude;
                break;
            case "Bing.Maps.Location.Longitude":
                userType = (XamlUserType)GetXamlTypeByName("Bing.Maps.Location");
                xamlMember = new XamlMember(this, "Longitude", "Double");
                xamlMember.Getter = get_30_Location_Longitude;
                xamlMember.Setter = set_30_Location_Longitude;
                break;
            case "MapUtilitiesSample.RoundMapMarker.MarkerText":
                userType = (XamlUserType)GetXamlTypeByName("MapUtilitiesSample.RoundMapMarker");
                xamlMember = new XamlMember(this, "MarkerText", "String");
                xamlMember.SetIsDependencyProperty();
                xamlMember.Getter = get_31_RoundMapMarker_MarkerText;
                xamlMember.Setter = set_31_RoundMapMarker_MarkerText;
                break;
            case "MapUtilitiesSample.RoundMapMarker.PositionAnchor":
                userType = (XamlUserType)GetXamlTypeByName("MapUtilitiesSample.RoundMapMarker");
                xamlMember = new XamlMember(this, "PositionAnchor", "Windows.Foundation.Point");
                xamlMember.Getter = get_32_RoundMapMarker_PositionAnchor;
                xamlMember.SetIsReadOnly();
                break;
            case "MapUtilitiesSample.SquareMapMarker.MarkerText":
                userType = (XamlUserType)GetXamlTypeByName("MapUtilitiesSample.SquareMapMarker");
                xamlMember = new XamlMember(this, "MarkerText", "String");
                xamlMember.SetIsDependencyProperty();
                xamlMember.Getter = get_33_SquareMapMarker_MarkerText;
                xamlMember.Setter = set_33_SquareMapMarker_MarkerText;
                break;
            case "MapUtilitiesSample.SquareMapMarker.PositionAnchor":
                userType = (XamlUserType)GetXamlTypeByName("MapUtilitiesSample.SquareMapMarker");
                xamlMember = new XamlMember(this, "PositionAnchor", "Windows.Foundation.Point");
                xamlMember.Getter = get_34_SquareMapMarker_PositionAnchor;
                xamlMember.SetIsReadOnly();
                break;
            case "Bing.Maps.Pushpin.Text":
                ...
                xamlMember.Getter = get_35_Pushpin_Text;
                xamlMember.Setter = set_35_Pushpin_Text;
                break;
            }
            return xamlMember;
        }
