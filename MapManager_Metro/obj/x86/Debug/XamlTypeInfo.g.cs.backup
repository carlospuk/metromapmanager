...
using FatAttitude.Utilities.Metro.Mapping.MapUtilities_Metro_XamlTypeInfo;

namespace FatAttitude.Utilities.Metro.Mapping.MapUtilities_Metro_XamlTypeInfo
{
...
namespace FatAttitude.Utilities.Metro.Mapping.MapUtilities_Metro_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_1_Map() { return new Bing.Maps.Map(); }

        private object Activate_2_MapUIElementCollection() { return new Bing.Maps.MapUIElementCollection(); }
        ...
        private object Activate_14_Location() { return new Bing.Maps.Location(); }
        ...
        private object get_7_Map_TileLayers(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.TileLayers;
        }
        private object get_8_MapTileLayer_Visible(object instance)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            return that.Visible;
        }
        private void set_8_MapTileLayer_Visible(object instance, object Value)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            that.Visible = (System.Boolean)Value;
        }
        private object get_9_MapTileLayer_ZIndex(object instance)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            return that.ZIndex;
        }
        private void set_9_MapTileLayer_ZIndex(object instance, object Value)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            that.ZIndex = (System.Int32)Value;
        }
        private object get_10_MapTileLayer_TileSource(object instance)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            return that.TileSource;
        }
        private void set_10_MapTileLayer_TileSource(object instance, object Value)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            that.TileSource = (System.String)Value;
        }
        private object get_11_MapTileLayer_Opacity(object instance)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            return that.Opacity;
        }
        private void set_11_MapTileLayer_Opacity(object instance, object Value)
        {
            var that = (Bing.Maps.MapTileLayer)instance;
            that.Opacity = (System.Double)Value;
        }
        private object get_12_Map_ShapeLayers(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.ShapeLayers;
        }
        private object get_13_MapShapeLayer_Visible(object instance)
        {
            var that = (Bing.Maps.MapShapeLayer)instance;
            return that.Visible;
        }
        private void set_13_MapShapeLayer_Visible(object instance, object Value)
        {
            var that = (Bing.Maps.MapShapeLayer)instance;
            that.Visible = (System.Boolean)Value;
        }
        private object get_14_MapShapeLayer_ZIndex(object instance)
        {
            var that = (Bing.Maps.MapShapeLayer)instance;
            return that.ZIndex;
        }
        private void set_14_MapShapeLayer_ZIndex(object instance, object Value)
        {
            var that = (Bing.Maps.MapShapeLayer)instance;
            that.ZIndex = (System.Int32)Value;
        }
        private object get_15_MapShapeLayer_Shapes(object instance)
        {
            var that = (Bing.Maps.MapShapeLayer)instance;
            return that.Shapes;
        }
        private void set_15_MapShapeLayer_Shapes(object instance, object Value)
        {
            var that = (Bing.Maps.MapShapeLayer)instance;
            that.Shapes = (Bing.Maps.MapShapeCollection)Value;
        }
        private object get_16_MapShape_Visible(object instance)
        {
            var that = (Bing.Maps.MapShape)instance;
            return that.Visible;
        }
        private void set_16_MapShape_Visible(object instance, object Value)
        {
            var that = (Bing.Maps.MapShape)instance;
            that.Visible = (System.Boolean)Value;
        }
        private object get_17_Map_RotationEnabled(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.RotationEnabled;
        }
        private object get_18_Map_HomeRegion(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.HomeRegion;
        }
        private void set_18_Map_HomeRegion(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.HomeRegion = (System.String)Value;
        }
        private object get_19_Map_Culture(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.Culture;
        }
        private void set_19_Map_Culture(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.Culture = (System.String)Value;
        }
        private object get_20_Map_TargetBounds(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.TargetBounds;
        }
        private object get_21_Map_Bounds(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.Bounds;
        }
        private object get_22_Map_ShowTraffic(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.ShowTraffic;
        }
        private void set_22_Map_ShowTraffic(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.ShowTraffic = (System.Boolean)Value;
        }
        private object get_23_Map_PreloadArea(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.PreloadArea;
        }
        private void set_23_Map_PreloadArea(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.PreloadArea = (Bing.Maps.PreloadArea)Value;
        }
        private object get_24_Map_MapType(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.MapType;
        }
        private void set_24_Map_MapType(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.MapType = (Bing.Maps.MapType)Value;
        }
        private object get_25_Map_TargetHeading(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.TargetHeading;
        }
        private object get_26_Map_TargetZoomLevel(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.TargetZoomLevel;
        }
        private object get_27_Map_TargetCenter(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.TargetCenter;
        }
        private object get_28_Map_Heading(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.Heading;
        }
        private void set_28_Map_Heading(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
            that.Heading = (System.Double)Value;
        }
        private object get_29_Map_ZoomLevel(object instance)
        {
            var that = (Bing.Maps.Map)instance;
            return that.ZoomLevel;
        }
        private void set_29_Map_ZoomLevel(object instance, object Value)
        {
            var that = (Bing.Maps.Map)instance;
        ...
        private object get_31_Map_MetersPerPixel(object instance)
        {
            var that = (Bing.Maps.Map)instance;
        ...
        private IXamlMember CreateXamlMember(string longMemberName)
        {
            ...
            case "Bing.Maps.Map.TileLayers":
                ...
                xamlMember.Getter = get_7_Map_TileLayers;
                xamlMember.SetIsReadOnly();
                break;
            ...
            case "Bing.Maps.Map.MetersPerPixel":
                ...
                xamlMember.Getter = get_31_Map_MetersPerPixel;
                xamlMember.SetIsReadOnly();
                break;
